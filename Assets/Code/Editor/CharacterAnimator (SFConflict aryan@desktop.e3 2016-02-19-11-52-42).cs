...
public class CharacterAnimator {
	...
	public static RuntimeAnimatorController Create (SmwCharacterGenerics smwCharacterGenerics, SmwCharacter smwCharacter, Teams teamId)
	{
		...
		if(!AssetTools.CreateFolder(createdCharacterFolderPath))
		{
		...
		AnimatorController controller =  AnimatorController.CreateAnimatorControllerAtPath( "Assets/" + createdCharacterFolderPath + "/" + charName + "_" + teamId + "_scripted_AnimatorController.controller");
...
//		controller.layers[1].defaultWeight = 1f;
        ...
        GenerateAnimationClipAssets(smwAnimations, createdCharacterFolderPath);
    ...
    static void GenerateAnimationClipAssets(List<SMWAnimation> smwAnimations, string createdCharacterFolderPath)
    {
